...
describe('isHttpUrl', () => {
  it("should return true when given 'http://ptelive.com'", () => {
    expect(isHttpUrl('http://ptelive.com')).toBe(true);
  });

  it("should return true when given 'https://ptelive.com'", () => {
    expect(isHttpUrl('https://ptelive.com')).toBe(true);
  });

  it("should return false when given 'ftp://ptelive.com'", () => {
    expect(isHttpUrl('ftp://ptelive.com')).toBe(false);
  });

  it("should return false when given 'ptelive.com'", () => {
    expect(isHttpUrl('ptelive.com')).toBe(false);
  });
});
